...
#define PanSource	"phase_c_model.pml"
...
#define _nstates12	11	/* valid_light_topology */
#define minseq12	1052
#define maxseq12	1061
#define _endstate12	10

#define _nstates11	11	/* mutual_exclusion_lights */
#define minseq11	1042
#define maxseq11	1051
#define _endstate11	10

#define _nstates10	11	/* fair_green_bounded */
#define minseq10	1032
#define maxseq10	1041
#define _endstate10	10

#define _nstates9	11	/* eventual_green_bounded */
#define minseq9	1022
#define maxseq9	1031
#define _endstate9	10

#define _nstates8	7	/* tour_closure */
#define minseq8	1016
#define maxseq8	1021
#define _endstate8	6

#define _nstates7	7	/* visit_all_bcd */
#define minseq7	1010
#define maxseq7	1015
#define _endstate7	6

#define _nstates6	11	/* no_uturn */
#define minseq6	1000
#define maxseq6	1009
#define _endstate6	10

#define _nstates5	11	/* no_opposite_direction */
#define minseq5	990
#define maxseq5	999
#define _endstate5	10

#define _nstates4	11	/* no_red_violation */
#define minseq4	980
#define maxseq4	989
#define _endstate4	10

#define _nstates3	11	/* no_collision */
#define minseq3	970
#define maxseq3	979
#define _endstate3	10

#define _nstates2	372	/* :init: */
#define minseq2	599
#define maxseq2	969
#define _endstate2	371

#define _nstates1	358	/* VehicleFSM */
#define minseq1	242
#define maxseq1	598
#define _endstate1	357

#define _nstates0	243	/* InfraFSM */
#define minseq0	0
#define maxseq0	241
#define _endstate0	242
...
typedef struct P12 { /* valid_light_topology */
...
typedef struct P11 { /* mutual_exclusion_lights */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 10; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P10 { /* fair_green_bounded */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 10; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P9 { /* eventual_green_bounded */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 10; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P8 { /* tour_closure */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 10; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P7 { /* visit_all_bcd */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 10; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P5 { /* no_opposite_direction */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 10; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P4 { /* no_red_violation */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 10; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P3 { /* no_collision */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 10; /* state    */
#ifdef HAS_PRIORITY
...
#define Air2	(sizeof(P2) - Offsetof(P2, _8_5_1_src_d1) - 1*sizeof(uchar))

#define PVehicleFSM	((P1 *)_this)
typedef struct P1 { /* VehicleFSM */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 10; /* state    */
#ifdef HAS_PRIORITY
	unsigned _priority : 8; /* 0..255 */
#endif
	unsigned _7_2_is_uturn : 1;
	unsigned _7_2_is_forbidden : 1;
	uchar vid;
	uchar dummy;
	uchar _7_2_cur_node;
	uchar _7_2_next_node;
	uchar _7_2_cur_slot;
	uchar _7_2_out_dir;
	uchar _7_2_road_id;
	uchar _7_2_lane_dir;
	uchar _7_2_dest_node;
	uchar _7_2_incoming;
	uchar _7_2_in_heading;
	uchar _7_2_last_sl;
	uchar _7_2_nh;
	uchar _7_2_inc_idx;
} P1;
#define Air1	(sizeof(P1) - Offsetof(P1, _7_2_inc_idx) - 1*sizeof(uchar))

#define PInfraFSM	((P0 *)_this)
typedef struct P0 { /* InfraFSM */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 10; /* state    */
#ifdef HAS_PRIORITY
	...
	uchar _6_1_i;
	uchar _6_1_best_dir;
	uchar _6_1_best_count;
	uchar _6_1_starved_dir;
	uchar _6_1_road_id;
	uchar _6_1_lane_dir;
	uchar nid2;
	uchar gc;
...
#define Air0	(sizeof(P0) - Offsetof(P0, _6_1_counts) - 4*sizeof(uchar))
...
typedef struct State {
	...
	#endif
#endif
	uchar light_enabled[40];
	uchar visited_B[2];
	uchar visited_C[2];
	uchar visited_D[2];
	uchar returned_A[2];
	uchar node_occupied[10];
	uchar moved_this_step[2];
	unsigned collision : 1;
	unsigned red_violation : 1;
	unsigned uturn_violation : 1;
	unsigned opposite_direction_violation : 1;
	unsigned model_initialized : 1;
	uchar next_hop_ha[500];
	uchar road_slots[78];
	uchar light_green[10];
	uchar red_streak[40];
	uchar veh_mode[2];
	uchar veh_node[2];
	uchar veh_road[2];
	...
	uchar veh_heading[2];
	uchar veh_dest[2];
	uchar veh_dest_idx[2];
	uchar tour_stops[8];
	uchar sq_a_forbidden[2];
	uchar crossing_count[10];
	uchar tick_infra;
	uchar done_infra;
	uchar tick_vehicle[2];
	uchar done_vehicle[2];
#ifdef TRIX
...
#define HAS_TRACK	0
/* hidden variable: */	uchar all_tours_done;
